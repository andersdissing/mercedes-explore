...
const CAPABILITY_MAPPINGS = [
  ...
  { id: 'ignition_on', title: 'Ignition', rawKey: 'ignitionstate', unit: '', transform: v => String(v) === '0' ? 'Off' : 'On' },
  { id: 'engine_running', title: 'Engine Running', rawKey: 'enginestate', unit: '', transform: v => (v === true || v === 'RUNNING') ? 'Yes' : 'No' },
  { id: 'climate_active', title: 'Climate Active', rawKey: 'precondActive', unit: '', transform: v => v === true ? 'Yes' : 'No' },
...
const FLOW_ACTIONS = [
  ...
  { id: 'start_charging', title: 'Resume charging', description: 'Resumes vehicle charging (deprecated: command no longer supported by Mercedes API)' },
  { id: 'stop_charging', title: 'Pause charging', description: 'Pauses vehicle charging (deprecated: command no longer supported by Mercedes API)' },
  ...
  { id: 'configure_max_soc', title: 'Set maximum charge level', description: 'Sets max battery charge level via WebSocket command (args: max_soc %)' },
...
const FLOW_TRIGGERS = [
  { id: 'vehicle_locked', title: 'Vehicle was locked', description: 'Triggers when the vehicle is locked (deprecated)' },
  { id: 'vehicle_unlocked', title: 'Vehicle was unlocked', description: 'Triggers when the vehicle is unlocked (deprecated)' },

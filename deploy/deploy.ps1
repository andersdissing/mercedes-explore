...
$configContent = "// Generated by deploy script - points to Azure Function proxy`nconst PROXY_CONFIG = { proxyUrl: '$functionUrl/api/proxy' };`n"
...
$localConfig = "// Proxy configuration - overridden during Azure deployment`nconst PROXY_CONFIG = { proxyUrl: '/api/proxy' };`n"

...
// Storage Account — hosts static website AND serves as function app storage
...
// Consumption App Service Plan (pay-per-execution, essentially free for light usage)
